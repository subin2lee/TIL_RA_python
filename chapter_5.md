...
<br> : 함수에 인수를 넘길 때 **값**만 넘김
<br> : 함수 내부의 인수값 변경 시 **호출된 변수에 영향을 주지 않음**

* 참조 호출 (call by reference)
<br> : 함수에 인술르 넘길 때 **메모리 주소**를 넘김
<br> : 함수 내부의 인수값 변경 시 **호출된 변수값도 변경됨**
...
💡 같은 메모리 주소를 갖고 있는 변수로 사용하기 위해선 **global** 키워드를 사용함.
```python
def f() :
    global s
